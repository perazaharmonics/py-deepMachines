...
deep_ae.compile(optimizer=optimizer, loss='mse')
...
# Train the model
deep_ae.fit(X_train, X_train, epochs=num_epoch, batch_size=batch_size, shuffle=True, validation_data=(X_test, X_test), verbose=1, callbacks=[tensorboard, checkpoint])
